// ── ISO 3166-1 alpha-2 → alpha-3 lookup ──────────────────────────────────────
// Needed because traveldoc.aero's InfoPages API (used by server/index.js for
// health/customs advisories) keys its URLs by ICAO3/alpha-3 country code
// (e.g. CHN, DNK) while the rest of this plugin uses alpha-2 everywhere else.
// Source: github.com/lukes/ISO-3166-Countries-with-Regional-Codes (MIT).
const ISO2_TO_ISO3 = {
